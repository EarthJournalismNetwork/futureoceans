...
(function ($) {
	...
	jeo.build = function (conf, callback) {
		...
		// by mohjak: test update mapbox to modern mapbox studio as described here
		// https://docs.mapbox.com/help/troubleshooting/migrate-legacy-static-tiles-api/#check-your-account-for-custom-classic-styles
		/*
		...
		$.each(layers, function (i, layer) {
			...
			if (layer.type == 'cartodb' && layer.cartodb_type == 'viz') {
				...
				*/
				...
				// var player = L.mapbox.styleLayer(layer.mapbox_id);
